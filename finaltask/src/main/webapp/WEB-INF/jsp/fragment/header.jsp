...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/index">Сериалы</a>
            </li>
    ...
    <c:if test="${sessionScope.user == null}">
        <div>
            <a href="/login" class="btn btn-dark btn-lg active" role="button" aria-pressed="true">Войти</a>
        </div>
    </c:if>
    <c:if test="${sessionScope.user != null}">
        <div>
            <a href="/profile" class="btn btn-dark btn-lg active mr-3" role="button"
               aria-pressed="true">${sessionScope.user}</a>
        </div>
        <div>
            <a href="/logout" class="btn btn-dark btn-lg active" role="button" aria-pressed="true">Выход</a>
        </div>
    </c:if>
</nav>