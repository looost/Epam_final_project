...
public class ViewedSerial implements Command {
    ...
    public CommandResponse execute(final HttpServletRequest req,
        ...
        try {
            ...
            int countSerial = ServiceFactory.getInstance().getSerialService().countAllSerialsThatUserWatch(userId);
            List<Serial> serialList = ServiceFactory.getInstance()
                    .getSerialService().findSerialsThatUserWatch(userId, page, COUNT_SERIAL_IN_MY_SHOWS_PAGE);
